    ...
    <React.Fragment>
      ...
      <div className="p-inputgroup">
        ...
        <Dropdown
          ...
          placeholder={
            selectedCustomer ? selectedCustomer.zoneName : "Select a Zone"
          }
        />
      </div>
      <br />
      <div className="p-inputgroup">
        ...
        <InputText
          id="addr1"
          placeholder={selectedCustomer.addr1}
          onKeyUp={(e) =>
            e.code === "Enter" &&
      ...
      <div className="p-inputgroup">
        ...
        <InputText
          id="addr2"
          placeholder={selectedCustomer.addr2}
          onKeyUp={(e) =>
            e.code === "Enter" &&
            setSelectedCustomer(setValue(e, selectedCustomer))
          }
      ...
      <div className="p-inputgroup">
        ...
        <InputText
          id="city"
          placeholder={selectedCustomer.city}
          onKeyUp={(e) =>
            e.code === "Enter" &&
            setSelectedCustomer(setValue(e, selectedCustomer))
          }
      ...
      <div className="p-inputgroup">
        ...
        <InputText
          id="zip"
          placeholder={selectedCustomer.zip}
          onKeyUp={(e) =>
            e.code === "Enter" &&
            setSelectedCustomer(setValue(e, selectedCustomer))
          }
