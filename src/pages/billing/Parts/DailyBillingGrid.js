...
import { ExpandedBillingRows } from "./ExpandedBillingRows";
...
const BillingGrid = ({ altPricing, nextInv, invoices, setInvoices, zones }) => {
  ...
  useEffect(() => {
    try {
      ...
      let custListArray = buildCustList(fullOrder, customers);
      ...
      <div className="card">
        ...
        <DataTable
          ...
          rowExpansionTemplate={(e) =>
            ExpandedBillingRows(e, invoices, setInvoices, pickedProduct, setPickedProduct)
          }
          dataKey="invNum"
