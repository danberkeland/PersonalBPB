            ...
            {standArray ? standArray.map(order =>
                (<React.Fragment key={order[0]+"frag"}>
                    ...
                    <input type="text" key={order[0]+"sun"} size="3" maxLength="3" id={order[0]+"_1"} name={order[0]}
                        placeholder={order[1]} onKeyUp={e => {handleQtyModify(e,e.target.value)}} onBlur={(e) => {e.target.value = ''}}></input>
                    <input type="text" key={order[0]+"mon"} size="3" maxLength="3" id={order[0]+"_2"} name={order[0]}
                        placeholder={order[2]} onKeyUp={e => {handleQtyModify(e,e.target.value)}} onBlur={(e) => {e.target.value = ''}}></input>
                    <input type="text" key={order[0]+"tues"} size="3" maxLength="3" id={order[0]+"_3"} name={order[0]}
                        placeholder={order[3]} onKeyUp={e => {handleQtyModify(e,e.target.value)}} onBlur={(e) => {e.target.value = ''}}></input>
                    <input type="text" key={order[0]+"wed"} size="3" maxLength="3" id={order[0]+"_4"} name={order[0]}
                        placeholder={order[4]} onKeyUp={e => {handleQtyModify(e,e.target.value)}} onBlur={(e) => {e.target.value = ''}}></input>
                    <input type="text" key={order[0]+"thurs"} size="3" maxLength="3" id={order[0]+"_5"} name={order[0]}
                        placeholder={order[5]} onKeyUp={e => {handleQtyModify(e,e.target.value)}} onBlur={(e) => {e.target.value = ''}}></input>
                    <input type="text" key={order[0]+"fri"} size="3" maxLength="3" id={order[0]+"_6"} name={order[0]}
                        placeholder={order[6]} onKeyUp={e => {handleQtyModify(e,e.target.value)}} onBlur={(e) => {e.target.value = ''}}></input>
                    <input type="text" key={order[0]+"sat"} size="3" maxLength="3" id={order[0]+"_7"} name={order[0]}
                        placeholder={order[7]} onKeyUp={e => {handleQtyModify(e,e.target.value)}} onBlur={(e) => {e.target.value = ''}}></input>
