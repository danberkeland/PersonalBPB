...
export const bagStickerSet = () => {
  ...
  doc.setFontSize(12); 
  doc.text(`Bread Flour`, 1.2, .80);
  doc.text(`10.87`, 0.3, .80);
  doc.text(`lb.`, 0.8, .80);
  ...
  doc.text(`65 lb. Batch`, 2.9, 0.36);
  doc.setFontSize(12);
  doc.text(`Water`, 1.2, .80);
  doc.text(`7.96`, 0.3, .80);
  doc.text(`lb.`, 0.8, .80);
